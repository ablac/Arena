...
assert.match(desktopHTML, /js\/app\.js\?v=20260714b/);
assert.match(mobileHTML, /mobile\.js\?v=20260714b/);
assert.match(shopHTML, /cosmetics-shop\.js\?v=20260714b/);
assert.match(appSource, /renderer\/engine\.js\?v=20260714b/);
assert.match(mobileSource, /renderer\/engine\.js\?v=20260714b/);
assert.match(shopSource, /shop-preview\.js\?v=20260714b/);
assert.match(engineSource, /bots\.js\?v=20260714b/);
assert.match(engineSource, /trails\.js\?v=20260713c/);
assert.match(botsSource, /bot-body\.js\?v=20260714b/);
assert.match(botsSource, /character-rig\.js\?v=20260714b/);
assert.match(botsSource, /cosmetics\.js\?v=20260714b/);
assert.match(botBodySource, /character-rig\.js\?v=20260714b/);
assert.match(rigSource, /forge-weapons\.js\?v=20260714b/);
