...
assert.match(desktopHTML, /js\/app\.js\?v=20260907a/);
assert.match(mobileHTML, /mobile\.js\?v=20260907a/);
...
assert.match(appSource, /renderer\/engine\.js\?v=20260907a/);
assert.match(mobileSource, /renderer\/engine\.js\?v=20260907a/);
