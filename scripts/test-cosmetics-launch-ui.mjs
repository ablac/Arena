...
assert.match(desktopHTML, /js\/app\.js\?v=20260712e/);
assert.match(mobileHTML, /mobile\.js\?v=20260712d/);
assert.match(shopHTML, /cosmetics-shop\.js\?v=20260712f/);
assert.match(appSource, /renderer\/engine\.js\?v=20260712d/);
assert.match(mobileSource, /renderer\/engine\.js\?v=20260712d/);
assert.match(shopSource, /shop-preview\.js\?v=20260712d/);
assert.match(engineSource, /bots\.js\?v=20260712c/);
assert.match(botsSource, /bot-body\.js\?v=20260712c/);
