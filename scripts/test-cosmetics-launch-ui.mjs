...
assert.match(desktopHTML, /js\/app\.js\?v=20260714e/);
assert.match(mobileHTML, /mobile\.js\?v=20260714e/);
assert.match(shopHTML, /cosmetics-shop\.js\?v=20260714e/);
...
assert.match(botsSource, /bot-body\.js\?v=20260714e/);
