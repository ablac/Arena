...
LOCATIONS:
C:/Projects/Arena-baleen/frontend/js/renderer/animations.js:23-32 (WEAPON_ANIMS per-weapon phase configs)
C:/Projects/Arena-baleen/frontend/js/renderer/animations.js:157-326 (updateBotAnim priority state machine: death>respawn>dodge>attack>idle)
C:/Projects/Arena-baleen/frontend/js/renderer/animations.js:334-379 (triggerAttack/triggerShove/triggerDodge interruption rules)
C:/Projects/Arena-baleen/frontend/js/renderer/swordsman-anims.js:142-179 (4 HEMA guard poses)
C:/Projects/Arena-baleen/frontend/js/renderer/swordsman-anims.js:182-268 (TODO placeholder attack keyframes, _quickSwing/_quickThrust, ATTACK_ANIMS)
C:/Projects/Arena-baleen/frontend/js/renderer/swordsman-anims.js:287-293 (stanceForHp: HP-driven stance selection)
C:/Projects/Arena-baleen/frontend/js/renderer/effects.js:15-22 (HIT_EFFECTS per-weapon spark configs)
C:/Projects/Arena-baleen/frontend/js/renderer/effects.js:221-311 (spawnWeaponStrike slash billboard + sword wake)
C:/Projects/Arena-baleen/frontend/js/renderer/effects.js:449-509 (spawnDamageNumber: pooled, DEFINED BUT NEVER CALLED)
C:/Projects/Arena-baleen/frontend/js/renderer/effects.js:512-530 (_deathBurst: generic 20-particle death)
C:/Projects/Arena-baleen/frontend/js/renderer/effects.js:537-696 (spawnGrappleEffect chain 3-phase)
C:/Projects/Arena-baleen/frontend/js/renderer/bots.js:122-161 (inferred attack detection from action + cooldown_remaining jump)
C:/Projects/Arena-baleen/frontend/js/renderer/bots.js:163-199 (shove/grapple/dodge inference; onGrapple callback is never wired in engine.js = dead path)
C:/Projects/Arena-baleen/frontend/js/renderer/bots.js:315-347 (playImpactReaction: white flash + squash, only for event-driven weapons)
C:/Projects/Arena-baleen/frontend/js/renderer/engine.js:115-134 (onAttack/onDodge/onShove wiring for inferred path)
C:/Projects/Arena-baleen/frontend/js/renderer/engine.js:254-370 (_playArenaEvents: WS event dispatch, id dedupe)
C:/Projects/Arena-baleen/frontend/js/renderer/trails.js:10-171 (movement ribbon system, updatable ribbon + vertex alpha)
C:/Projects/Arena-baleen/frontend/js/renderer/weapons.js:28-34 (createWeaponMesh dispatch; roots expose _children/_bowString)
C:/Projects/Arena-baleen/frontend/js/renderer/bot-body.js:120-252 (capsule bot assembly: static instanced arms, GUI HP bar)
C:/Projects/Arena-baleen/frontend/js/renderer/projectiles.js:9-156 (arrow/bolt keyframe flight + particle trail)
C:/Projects/Arena-baleen/go-arena/internal/game/state.go:393-405 (ArenaEvent struct: no damage field, no kill/hit event type)
C:/Projects/Arena-baleen/go-arena/internal/game/arena_events.go:5-197 (all 12 server event builders)