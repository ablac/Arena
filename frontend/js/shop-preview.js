...
import { createBotEntry, disposeBotEntry } from './renderer/bot-body.js?v=20260714b';
import { applyBotCosmetics, disposeBotCosmetics } from './renderer/cosmetics.js?v=20260714b';
import { updateForgeCharacter } from './renderer/character-anims.js?v=20260714b';
import { TrailRenderer } from './renderer/trails.js?v=20260713c';
import {bodyFormKeyForBot} from './renderer/body-form-roster.js?v=20260714b';
