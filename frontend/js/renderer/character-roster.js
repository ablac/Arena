...
export const CHARACTER_ROSTER = Object.freeze({
  sword: profile({
    weapon: 'sword', callsign: 'Vanguard', role: 'balanced duelist', armor: 'keel helm and layered duelist cuirass',
    proportions: {shoulders: 1.00, torso: 0.94, hips: 0.88, leg: 1.00, posture: 0.02, head: 0.94},
  ...
  spear: profile({
    weapon: 'spear', callsign: 'Lancer', role: 'reach controller', armor: 'spiked helm and vertical lance pauldrons',
    proportions: {shoulders: 0.91, torso: 1.04, hips: 0.82, leg: 1.08, posture: 0.10, head: 0.92},
  ...
  shield: profile({
    weapon: 'shield', callsign: 'Bulwark', role: 'front-line anchor', armor: 'sunken visor and bastion shoulder carapace',
    proportions: {shoulders: 1.32, torso: 0.90, hips: 1.22, leg: 0.93, posture: 0.07, head: 1.02},
  ...
  grapple: profile({
    weapon: 'grapple', callsign: 'Rigger', role: 'mobility engineer', armor: 'offset optic and exposed dorsal cable drum',
    proportions: {shoulders: 1.03, torso: 0.88, hips: 0.98, leg: 0.98, posture: 0.12, head: 0.88},
