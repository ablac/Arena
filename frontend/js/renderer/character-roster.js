...
export const CHARACTER_ROSTER = Object.freeze({
  ...
  spear: profile({
    ...
    proportions: {shoulders: 0.92, torso: 0.90, hips: 0.76, leg: 1.08, posture: 0.10, head: 0.92},
  ...
  daggers: profile({
    ...
    proportions: {shoulders: 0.82, torso: 0.78, hips: 0.78, leg: 0.86, posture: 0.12, head: 0.86},
  ...
  shield: profile({
    ...
    proportions: {shoulders: 1.28, torso: 1.12, hips: 1.05, leg: 0.93, posture: 0.07, head: 1.02},
  ...
  grapple: profile({
    ...
    proportions: {shoulders: 1.04, torso: 0.94, hips: 0.82, leg: 0.98, posture: 0.12, head: 0.88},
