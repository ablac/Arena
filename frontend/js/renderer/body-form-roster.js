...
const rawSpecs = [
  ...
  ['bullfrog', 'Bullfrog', 'amphibian', '#4f9b4f', '#a9cf5f', '#f2d85c', 17, ['frogEyes', 'wideMouth', 'webFeet'],
    {flavor: 'hop', stride: 0.7, posture: 0.08}],
  ...
  ['tyrant_rex', 'Tyrant Rex', 'reptile', '#5f8f48', '#b7c86d', '#ff8b45', 22, ['dinoSnout', 'brow', 'dinoTail', 'claws'],
    {flavor: 'lumber', stride: 0.8, bob: 1.35, posture: 0.14}],
